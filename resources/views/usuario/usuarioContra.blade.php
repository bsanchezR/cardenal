  ...
  <script type="text/javascript" src="{{ asset('widgets/parsley/parsley.js') }}"></script>
                    ...
                    <div class="panel">
                        <div class="panel-body">
                            <h3 class="title-hero">Cambiar Contraseña</h3>
                            <div class="example-box-wrapper">
                                <form class="form-horizontal bordered-row" id="demo-form">
                                    <div class="form-group">
                                        <label class="col-sm-3 control-label">Password</label>
                                        <div class="col-sm-6">
                                            <input type="text" id="ps1" required class="form-control" placeholder="Password" data-parsley-required-message="Porfavor ingresa tu password">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="bg-default text-center pad20A mrg25T">
                                        <button class="btn btn-lg btn-default">Cancelar</button>
