    ...
    @foreach($citas as $cita)
        ...
        <tr>
            ...
            <td style="text-align:center;">
                {!! Form::open(['route' => ['citas_instala.destroy', $cita->id], 'method' => 'delete']) !!}
                <div class='btn-group'>
                    <a href="{!! route('citas_instala.show', [$cita->id]) !!}" class='btn btn-default btn-md'><i class="glyph-icon icon-eye"></i></a>
                    @if(Auth::user()->tipo_usuario === 'administrador')
                    <a href="{!! route('citas_instala.edit', [$cita->id]) !!}" class='btn btn-default btn-md'><i class="glyph-icon icon-pencil"></i></a>
